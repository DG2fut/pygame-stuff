...
pygame.display.set_caption("Ponging your mom")
...
class Paddle: #class created as there are multiple paddles
    COLOR = WHITE
    VEL = 7
...
def draw(win, paddles,ball,left_score,right_score):
    ...
    for i in range(10,HEIGHT,HEIGHT//20):
        if i % 2 == 1:
            continue
        pygame.draw.rect(
            win, WHITE ,(WIDTH//2 - 3, i,6,HEIGHT//20))
    ball.draw(win)
